...
<button style="width:100%; background:#3D9831; color:#fff;" id="submit_btn" class="btn">Login</button>
</div>


<div style="margin-top:30px; " class="text-center text-muted">
<a style="font-weight:bold;" href="<?= base_url('ForgotPassword')?>">Forgot Password</a>
</div>
</div>
</div>
</div>
...
$(function(){
    ...
    $("#submit_btn").click(function(e){
        ...
        else if(password.length < 6){ $("#error_msg").html("Sorry password should be more than 5 chars."); }    
        else
		{
